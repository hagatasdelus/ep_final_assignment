...
public class GradeChecker1 {
    ...
    void initialize(String csvFile) throws IOException {
        ...
        while ((line = in.readLine()) != null) {
            ...
            if (max < Integer.valueOf(array[0])) max = Integer.valueOf(array[0]);
        }
        in.close(); 
        this.gradeCheck(max);// 11
    }
    ...
    void gradeCheck(Integer max) {
        for (Integer i = 1; i <= max; i++) {
            ...
            String grade;
            if (Objects.equals(score, 0.0)) grade = "K";
            else if (score < 60.0) grade = "不可";
            else if (score < 70.0) grade = "可";
            else if (score < 80.0) grade = "良";
            else if (score < 90.0) grade = "優";
            else grade = "秀";
